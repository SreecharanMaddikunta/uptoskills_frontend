...
const Settings = () => {
  ...
  return (
    <div className="max-w-4xl mx-auto space-y-6 pb-12">
      ...
      {saved && (
        <div className="p-4 bg-green-50 dark:bg-green-900/30 text-green-700 dark:text-green-400 rounded-lg border border-green-200 dark:border-green-800 transition-all">
          Settings saved successfully!
        </div>
      )}
      
      {error && (
        <div className="p-4 bg-red-50 dark:bg-red-900/30 text-red-700 dark:text-red-400 rounded-lg border border-red-200 dark:border-red-800 transition-all">
          {error}
        </div>
      )}
